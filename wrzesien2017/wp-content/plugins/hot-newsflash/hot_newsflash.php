...
Plugin URI: http://hot-themes.com/wordpress/plugins/newsflash/
Description: Hot Newsflash plugin is a fully configurable, featured articles rotator, based on jQuery.
Author: HotThemes
...
class HotNewsflash extends WP_Widget {
	...
	function HotNewsflash() {
		...
		/* Create the widget. */
		parent::__construct( 'hot-newsflash', __('Hot Newsflash', 'hot_newsflash'), $widget_ops, $control_ops );
