...
class CS_Admin
{
    ...
    public function __construct()
    {
        ...
        $settings->add_field( 'cookimize_options', array(
        ...
        $settings->add_field( 'cookimize_style', array(
        ...
        $settings->add_field( 'cookimize_gdpr', array(
    ...
    public function add_admin_scripts()
    {
        ...
        wp_enqueue_script(
            'cookimize-admin-js',
            COOKIMIZE_URL . '/assets/admin/cookimize-admin.js',
            array( 'jquery' ),
            false
        );
