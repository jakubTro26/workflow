...
function vc_menu_page_build() {
	...
	add_menu_page( __( 'WPBakery Page Builder', 'js_composer' ), __( 'WPBakery Page Builder', 'js_composer' ), 'edit_posts', VC_PAGE_MAIN_SLUG, null, vc_asset_url( 'vc/visual_composer.png' ), 76 );
...
function vc_network_menu_page_build() {
	...
	add_menu_page( __( 'WPBakery Page Builder', 'js_composer' ), __( 'WPBakery Page Builder', 'js_composer' ), 'exist', VC_PAGE_MAIN_SLUG, null, vc_asset_url( 'vc/visual_composer.png' ), 76 );
