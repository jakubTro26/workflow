...
var appConfig = {
    "proxy": 'http://localhost/wp-eventpoint'
...
//define your project path , use linux style forward slash as dir seperator
var templatedir = "D:/xampp/htdocs/wp-eventpoint/wp-content/themes/lgx-event-point/assets/";
...
gulp.task('compile-less', function() {
   ...
   // var default_less2 = '';
    var default_less = gulp.src(templatedir+'less/main-style.less')
        .pipe(less())
        //.pipe(rename({suffix: '.min'}))
        .pipe(gulp.dest(templatedir+'css/')).on('end', function() {

            var default_less2 = gulp.src(templatedir+'css/main-style.css')
